/**
 * The single priority-order definition for keyboard shortcuts (#12).
 ...
 * entry to make a deliberate call (P1 from #41 review).
 *
 ...
 * (found in a second #41 review pass).
 *
 ...
 * and one of the two silently gets dropped at commit time (that's exactly what #41
 ...
 * happened with the rotation in #37 B2) — so this rejects them all in one place instead.
 */
