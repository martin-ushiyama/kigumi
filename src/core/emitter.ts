/** Unsubscribe function returned by subscribe() (the common convention here) */
 ...
 * separately in VoxelWorld.safeNotify / Document.notify. "Notification succeeding"
 ...
 * outcome to the caller (following a review finding).
...
export function createEmitter<T>(): {
  ...
  return {
    ...
    notify(event) {
      ...
      // event currently being delivered (a review finding: iterating the live Set
      ...
      // registration order — both violate the completion condition that behavior
